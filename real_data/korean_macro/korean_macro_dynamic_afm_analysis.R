...
# ============================================================
preproc_file <- file.path("data", "processed", "korean_macro_preprocessed.rds")
...
if (!file.exists(preproc_file)) {
  stop(
    ...
    "Run real_data/korean_macro/01_download_ecos_data.R and ",
    "real_data/korean_macro/02_preprocess_ecos_data.R before this script."
  )
}

preprocessed <- readRDS(preproc_file)
